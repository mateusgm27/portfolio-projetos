...
// CARREGAMENTO DE PRODUTOS (MODO ESTÁTICO/PORTFÓLIO PARA A VERCEL)
async function carregarProdutos() {
    console.log('Carregando catálogo completo de produtos do portfólio...');
    
    // Gera diretamente todos os produtos baseados no mapa de imagens
    ...
    if (conteudoModal) {
        conteudoModal.innerHTML = `
            ...
            <div class="detalhes-grid" style="text-align: left; display: grid; gap: 8px;">
                ...
                <p><strong>Estoque Disponível:</strong> ${produto.estoque || 10} unidades</p>
